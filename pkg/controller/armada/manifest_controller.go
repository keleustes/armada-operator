...
func (r *ManifestReconciler) Reconcile(ctx context.Context, request reconcile.Request) (reconcile.Result, error) {
	...
	forcedRequeue, err := r.reconcileArmadaManifest(mgr, instance)
	if err != nil {
...
func (r ManifestReconciler) reconcileArmadaManifest(mgr armadaif.ArmadaManifestManager, instance *av1.ArmadaManifest) (bool, error) {
	reclog := amflog.WithValues("namespace", instance.Namespace, "amf", instance.Name)
